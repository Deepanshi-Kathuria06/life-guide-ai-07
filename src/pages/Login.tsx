    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Log in to continue with ARIA</p>
        </div>
        ...
        <Card className="p-5 sm:p-8 bg-card/50 backdrop-blur-sm border-2">
          ...
          <div className="mt-4 text-center">
            <p className="text-xs sm:text-sm text-muted-foreground">
              ...
              <Button variant="link" className="p-0 text-primary text-xs sm:text-sm" onClick={() => navigate("/signup")}>Sign up</Button>
            </p>
          </div>
        </Card>
